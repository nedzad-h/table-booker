...
export default function ConfirmBookingModal({ booking }) {
  ...
  return (
    <>
      <button onClick={() => setOpen(!open)} type="button" className="flex items-center justify-center p-2 bg-green-500 hover:bg-green-600 text-white rounded-full focus:outline-none focus:ring focus:ring-green-300">
                      ...
                      <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                        ...
                        <div className="mt-2">
                          <p className="text-sm text-gray-500 text-justify">
                            Da li ste sigurni da želite potvrditi ovu rezervaciju? Ukoliko je rezervacija potvrđena, e-mail sa porukom o povrdi će biti poslan na odgovarajuću adresu.
                          </p>
                          <div className='pt-10'>
                            <div className="mb-4">
